...
namespace CloudLib.Client.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::CloudLib.Client.Core.Models.SampleOrderDetail dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::CloudLib.Client.Core.Models.SampleOrderDetail) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Core.Models.SampleOrderDetail)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::CloudLib.Client.Core.Models.SampleOrderDetail obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class TreeViewPage_obj17_Bindings :
            ...
            ITreeViewPage_Bindings
        {
            private global::CloudLib.Client.Core.Models.SampleOrder dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::CloudLib.Client.Core.Models.SampleOrder) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Core.Models.SampleOrder)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::CloudLib.Client.Core.Models.SampleOrder obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            ITreeViewPage_Bindings
        {
            ...
            private void Update_Details(global::System.Collections.Generic.ICollection<global::CloudLib.Client.Core.Models.SampleOrderDetail> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\TreeViewPage.xaml line 105
        ...
        private class TreeViewPage_obj31_Bindings :
            ...
            ITreeViewPage_Bindings
        {
            private global::CloudLib.Client.Core.Models.SampleCompany dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::CloudLib.Client.Core.Models.SampleCompany) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Core.Models.SampleCompany)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::CloudLib.Client.Core.Models.SampleCompany obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            ITreeViewPage_Bindings
        {
            ...
            private void Update_Orders(global::System.Collections.Generic.ICollection<global::CloudLib.Client.Core.Models.SampleOrder> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\TreeViewPage.xaml line 20
        ...
        private class TreeViewPage_obj1_Bindings :
            ...
            ITreeViewPage_Bindings
        {
            private global::CloudLib.Client.Views.TreeViewPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Views.TreeViewPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::CloudLib.Client.Views.TreeViewPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::CloudLib.Client.ViewModels.TreeViewViewModel obj, int phase)
            {
            ...
            private void Update_ViewModel_SampleItems(global::System.Collections.ObjectModel.ObservableCollection<global::CloudLib.Client.Core.Models.SampleCompany> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private class TreeViewPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_ViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::CloudLib.Client.ViewModels.TreeViewViewModel obj = sender as global::CloudLib.Client.ViewModels.TreeViewViewModel;
                ...
                private global::CloudLib.Client.ViewModels.TreeViewViewModel cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::CloudLib.Client.ViewModels.TreeViewViewModel obj)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 49: // Views\TreeViewPage.xaml line 332
                {
                    this.collapseBehavior = (global::CloudLib.Client.Behaviors.TreeViewCollapseBehavior)(target);
                }
                break;
            default:
                break;
