...
namespace CloudLib.Client.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class TabViewPage_obj5_Bindings :
            ...
            ITabViewPage_Bindings
        {
            private global::CloudLib.Client.Models.TabViewItemData dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::CloudLib.Client.Models.TabViewItemData) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Models.TabViewItemData)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::CloudLib.Client.Models.TabViewItemData obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class TabViewPage_obj1_Bindings :
            ...
            ITabViewPage_Bindings
        {
            private global::CloudLib.Client.Views.TabViewPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::CloudLib.Client.Views.TabViewPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::CloudLib.Client.Views.TabViewPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::CloudLib.Client.ViewModels.TabViewViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel_Tabs(global::System.Collections.ObjectModel.ObservableCollection<global::CloudLib.Client.Models.TabViewItemData> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
